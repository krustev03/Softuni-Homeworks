                ...
                switch (line[0])
                {
                    ...
                    case "Swap":
                        ...
                        if (lessons.Contains(line[1]) == true && lessons.Contains(line[2]) == true)
                        {
                            ...
                            if (lessons.Contains(line[1] + "-Exercise") == true && lessons.Contains(line[2] + "-Exercise") == true)
                            {
                            ...
                            else if (lessons.Contains(line[1] + "-Exercise") == true && lessons.Contains(line[2] + "-Exercise") == false)
                            {
                            ...
                            else if (lessons.Contains(line[1] + "-Exercise") == false && lessons.Contains(line[2] + "-Exercise") == true)
                            {
                        ...
                        break;
                    case "Exercise":
                        if (lessons.Contains(line[1]) == true && lessons.Contains(line[1] + "-Exercise") == false)
                        {
                            for (int i = 0; i < lessons.Count; i++)
                            {
                                if (lessons[i] == line[1])
