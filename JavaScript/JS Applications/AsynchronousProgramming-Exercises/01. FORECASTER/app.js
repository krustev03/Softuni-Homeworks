function attachEvents() {
    ...
    function getLocationValue() // Gets the data about the certain location (Valid locations are Barcelona, London and New York)
    {
    ...
    function showWeatherLocation([ todayData, upcomingData ]) // Shows the weather in certain location
    {
    ...
    function showUpcomingWeatherLocation({ forecast, name }) // Shows the weather in next three days
    {
        ...
        forecast.forEach(({ condition, high, low }) => 
        {
            ...
            let locationSpan = createHTMLElement('span', ['location-name'], `After ${counter} ${naming}`);
            counter++;
    ...
    function createHTMLElement(tagName, classNames, textContent) // A helpful function for faster creation of the html elements
    {
